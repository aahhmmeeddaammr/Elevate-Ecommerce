...
export default function MainSlider() {
  return (
    ...
    >
      <CarouselItem>
        <div className="bg-[url('/assets/main-slider.jpg')] bg-cover bg-center h-full p-8 md:p-12 flex items-center">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-main text-3xl md:text-5xl font-bold md:leading-14">
              Choose Perfect <br /> <span className="text-primary">Gifts</span>{" "}
              From Us
            </p>
            <p className="text-main max-w-48 md:max-w-sm leading-7">
              Culpa ducimus nesciunt aliquam non rerum esse recusandae omnis.
