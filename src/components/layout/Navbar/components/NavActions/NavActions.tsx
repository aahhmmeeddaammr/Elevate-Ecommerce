...
import { Briefcase, Heart, LogOut, Truck, User } from "lucide-react";
  ...
  return (
    <>
      <Link href={"/wishlist"} className="relative">
        <Heart className="text-primary hover:cursor-pointer" />
      </Link>
      <Link href={"/cart"} className="relative">
        <Briefcase className="text-primary hover:cursor-pointer" />
